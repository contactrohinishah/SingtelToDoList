...
public class TestConfig {
	...
	{
		String commonPropertyfilePath = "src/test/resources/config/common.properties";
	...
	{
		String propertiesFilePath = String.format("src/test/resources/config/%s.properties",requestedEnv);
